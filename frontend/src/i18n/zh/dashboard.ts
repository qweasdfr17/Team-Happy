...
export default {
  ...
  'content_mode_ad_desc': '短片模式——用一段创作描述（Brief）表达你的创作诉求，AI 根据角色/场景/道具参考图生成镜头与中文视频提示词草稿；你审改提示词后，再手动决定是否生成视频。适合漫剧片段、创意短片；如需产品带货，可在项目内补充产品信息。',
  ...
  'ad_init_subtitle': '填写创作诉求（Brief），可选上传产品图与产品信息，即可开始生成镜头提示词草稿',
  ...
  'flow_preflight_placeholder': '进入对应 episode 页面查看预检详情。',
  'flow_video_gen_note': '视频生成是高成本操作，请确认提示词无误后，在 episode 页面手动触发生成。',
  'flow_go_to': '前往处理',
