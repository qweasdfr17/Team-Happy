...
export default {
  ...
  'project_id_auto_gen_hint': '系统会自动生成内部项目标识并用于网址与文件存储',
  'narration_visuals': '旁白模式',
  'drama_animation': '剧集模式',
  'ad_short_video': '短片/漫剧片段',
  'content_mode_ad_desc': '短片模式——用一段创作简述表达你的创作诉求，智能体根据角色/场景/道具参考图生成镜头与中文视频提示词草稿；你审改提示词后，再手动决定是否生成视频。适合漫剧片段、创意短片；如需产品带货，可在项目内补充产品信息。',
  ...
  'api_keys': 'API 令牌',
  'about': '关于',
  'system_config_title': '系统配置与接口访问管理',
  'system_config_kicker': '控制台',
  ...
  'agent_sdk_desc': '基于 Claude 智能体开发套件，驱动对话式智能助手与自动化工作流',
  'claude_code_compat_hint': '配置项兼容 Claude Code 环境变量命名，可使用兼容 Claude Code 的编码套餐接口。',
  'api_access': 'API 访问',
  ...
  'key_created': '密钥已创建',
  'key_issued_kicker': '密钥已签发',
  'new_token_kicker': '新建令牌',
  ...
  'model_routing_kicker': '默认路由',
  'video_channel_kicker': '视频通道',
  'image_channel_kicker': '图片通道',
  'text_channel_kicker': '文本通道',
  'audio_channel_kicker': '音频通道',
  ...
  'update_prompt_failed': '更新提示词失败: {{message}}',
  ...
  'clear_saved_anthropic_key': '清除已保存的 Anthropic 接口密钥',
  'clear_saved': '清除已保存',
  'env_anthropic_base_url': '对应 ANTHROPIC_BASE_URL，留空使用官方默认地址',
  'clear_saved_base_url': '清除已保存的 Anthropic 基础地址',
  'model_config': '模型配置',
  'model_config_desc': '指定智能体使用的 Claude 模型。留空则使用 Claude 智能体开发套件默认值。',
  'default_model': '默认模型',
  'env_anthropic_model': '对应 ANTHROPIC_MODEL，覆盖默认模型',
  'clear_saved_model': '清除已保存的模型配置',
  'advanced_model_routing': '高级模型路由',
  'model_routing_hint': 'Claude 智能体开发套件支持按能力等级路由到不同模型。留空则统一使用上方的默认模型。',
  ...
  // config-status-store
  'agent_api_key_not_configured': '[[brand]] 智能体接口密钥（Anthropic）未配置',
  ...
  'episodes_title': '剧集',
  'no_episodes_ai_hint': '暂无剧集。使用智能助手生成剧本。',
  'segments_and_status': '{{count}} 片段 · {{status}}',

  // ProjectSettingsPage
  'project_settings': '项目设置',
  'project_settings_kicker': '项目工作台',
  'back_to_project': '返回项目',
  'model_config_project_desc': '为此项目单独选择生成模型，留空则跟随全局默认',
  'visual_style_kicker': '视觉风格',
  'engine_routing_kicker': '引擎路由',
  'video_model': '视频模型',
  ...
  'reference_canvas_empty': '尚未创建任何视频单元',
  'reference_unit_list_title': '视频单元',
  'reference_unit_new': '新建视频单元',
  'reference_preview_empty': '选中左侧视频单元查看预览',
  ...
  'reference_generate_deduped': '该视频单元已在队列中',
  ...
  'episode_mode_switch_keep_data': '切换模式不会删除已生成的视频单元与场景，可随时切回原模式继续。',
  'episode_mode_switch_to_reference': '切换到参考生视频：时间线中的分镜和宫格数据仍然保留，在下次切回时自动恢复。',
  'episode_mode_switch_from_reference': '切换回图生/宫格生视频：参考模式的视频单元会保留，切回时可继续生成。',
  // ========== PR5 reference-video editor ==========
  'reference_editor_placeholder': '输入提示词，支持“镜头 1（3 秒）：...”，用 @ 引用角色/场景/道具',
  'reference_editor_aria_name': '视频单元提示词',
  ...
  'edit_provider_kicker': '编辑供应商',
  'new_provider_kicker': '新建供应商',
  'connection_info_kicker': '连接信息',
  'cp_name_label': '名称',
  'cp_name_placeholder': '例如：我的 NewAPI…',
  'base_url': '基础地址',
  'api_key_label': '接口密钥',
  'keep_existing_key_hint': '留空则保留现有密钥',
  'enter_api_key_placeholder': '输入接口密钥',
  'preview_url': '预览：',
  'discover_models': '获取模型列表',
  'discover_models_success': '已发现 {{count}} 个模型',
  'discover_no_models': '未发现可用模型',
  'discover_no_base': '请先选择预设或填写基础地址',
  'discover_api_key_required': '请先填写接口密钥再获取模型',
  ...
  'fill_base_url_first': '请先填写基础地址',
  'fill_api_key_first': '请先填写接口密钥',
  'base_url_changed_reenter_key': '基础地址已修改，请重新输入接口密钥后再发现模型',
  'fill_provider_name': '请填写供应商名称',
  'fill_base_url': '请填写基础地址',
  'fill_api_key': '请填写接口密钥',
  ...
  'discovery_format_openai': '开放人工智能兼容',
  'discovery_format_google': '谷歌人工智能工作室',
  'endpoint_label': '调用端点',
  'endpoint_text_group': '文本',
  'endpoint_image_group': '图片',
  'endpoint_video_group': '视频',
  'endpoint_audio_group': '语音',
  'endpoint_openai_chat_display': '开放人工智能文本',
  'endpoint_gemini_generate_display': '谷歌双子座文本',
  'endpoint_openai_images_display': '开放人工智能图片',
  'endpoint_openai_images_generations_display': '开放人工智能图片（仅文生图）',
  'endpoint_openai_images_edits_display': '开放人工智能图片（仅图生图）',
  'endpoint_gemini_image_display': '谷歌双子座图片',
  'endpoint_openai_video_display': '开放人工智能视频',
  'endpoint_newapi_video_display': '统一接口视频',
  'endpoint_v2_video_generations_display': '第二版统一视频',
  'endpoint_ark_seedance_display': '火山方舟即梦视频',
  'endpoint_vidu_video_display': '生数科技视频',
  ...
  'endpoint_minimax_video_display': 'MiniMax 海螺视频',
  'endpoint_kling_image_display': '可灵图片',
  'endpoint_kling_video_display': '可灵视频',
  'endpoint_openai_tts_display': '开放人工智能语音合成',
  ...
  'reference_units_split_complete': '视频单元拆分已完成（{{count}} 个单元）',
  'reference_units_split_complete_label': '视频单元拆分已完成',
  ...
  'episode_collapsed_button_label': '第 {{episode}} 集 · {{title}}',
  ...
  'episode_header_episode_chip': '第 {{number}} 集',
  ...
  'tool_call_skill_content_label': '技能内容',
  ...
  'shot_notes_placeholder': '关于 {{id}} 的备注：参考、修改方向、待办…',
  ...
  'detail_shot_section_placeholder': '如开场钩子 / 卖点 / 行动号召…',
  ...
  'ad_init_title': '准备创作素材',
  'ad_init_subtitle': '填写创作简述，可选上传产品图与产品信息，即可开始生成镜头提示词草稿',
  ...
  'ad_init_brief_label': '创作简述',
  'ad_init_brief_placeholder': '描述你想要的短片：主题、风格调性、情绪基调、叙事节奏……（如需带货可补充卖点与行动号召）',
  'ad_init_generate_sheet_label': '生成标准产品参考图',
  'ad_init_generate_sheet_hint': '把随手拍整理成标准多角度设计图，生成后可在产品页审核与重新生成',
  'ad_init_product_incomplete_hint': '产品信息不完整：请同时填写产品名称与产品描述；如不需要产品，请清空产品区后仅提交创作简述',
  ...
  'script_policy_preserve_desc': '智能体只能切分、提取角色和生成提示词，不修改原文',
  'script_policy_suggest': '先给我修改建议',
  'script_policy_suggest_desc': '智能体生成改稿建议但不直接写入，用户审核后再决定',
  'script_policy_rewrite': '允许智能体改写',
  'script_policy_rewrite_desc': '（预留）用户确认后允许智能体改写剧本',

  'flow_map_title': '流程地图',
  'flow_readonly_hint': '只读 · 点击节点查看详情',
  'flow_status_idle': '未开始',
  'flow_status_active': '进行中',
  'flow_status_done': '已完成',
  'flow_status_warn': '需检查',
  'flow_status_blocked': '阻断',
  'flow_detail_counts': '数量',
  'flow_detail_items': '检查项',
  'flow_count_total': '总数',
  'flow_count_scripted': '已生成剧本',
  'flow_count_missing': '缺失',
  'flow_count_shots': '镜头',
  'flow_count_units': '视频单元',
  'flow_count_characters': '角色',
  'flow_count_scenes': '场景',
  'flow_count_props': '道具',
  'flow_count_products': '产品',
  'flow_source_note': '原始剧本默认不允许改写。分集规划、JSON 剧本、提示词均为派生作品。',
  'flow_preflight_placeholder': '进入对应剧集页面查看预检详情。',
  'flow_video_gen_note': '视频生成是高成本操作，请确认提示词无误后，在剧集页面手动触发生成。',
  'flow_go_to': '前往处理',
  ...
  'lobby_now_editing_eyebrow': '接着上一次 · 当前制作',
  'lobby_continue_editing_chip': '继续制作',
  'lobby_library_eyebrow': '全部项目 · 项目库',
  ...
  'diagnosis_openai_compat_only': '该端点返回开放人工智能兼容协议，Claude 客户端无法直接使用，请确认是否选错套餐',
  'diagnosis_auth_failed': '接口密钥无效或已过期',
  'diagnosis_model_not_found': '模型不存在，请先发现可用模型',
  'diagnosis_rate_limited': '触发限流，稍后重试',
  'diagnosis_network': '网络无法访问，检查地址与防火墙',
