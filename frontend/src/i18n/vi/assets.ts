...
export default {
  ...
  "field.voice_reference": "Tham chiếu giọng nói",
  "upload_audio_optional": "Nhấn để tải âm thanh tham chiếu (tuỳ chọn)",
  "replace_audio": "Nhấn để thay âm thanh tham chiếu",
  "create": "Tạo",
  "save": "Lưu",
  ...
  "costume_references": "Trang phục tham khảo",
  "add_costume": "Thêm trang phục",
  "delete_costume": "Xóa trang phục",
  "delete_costume_confirm": "Xóa trang phục \"{{label}}\" của \"{{name}}\"?",
  "costume_label_placeholder": "VD: Thường phục vương gia",
  "costume_desc_placeholder": "Chi tiết vải, màu sắc, hoa văn...",
  "variants": "Biến thể nhân vật",
  "add_variant": "Thêm biến thể",
  "delete_variant": "Xóa biến thể",
  "delete_variant_confirm": "Xóa biến thể \"{{label}}\" của \"{{name}}\"?",
  "variant_label_placeholder": "VD: Thiếu niên, Trưởng thành, Chiến tổn",
  "variant_desc_placeholder": "Thay đổi tuổi tác, vóc dáng, khí chất...",
  "upload_variant_sheet": "Tải lên thiết kế biến thể",
