...
export default {
  ...
  'system_config_kicker': 'Bảng điều khiển',
  ...
  'key_issued_kicker': 'Đã cấp khóa',
  'new_token_kicker': 'Mã mới',
  ...
  'model_routing_kicker': 'Định tuyến mặc định',
  'video_channel_kicker': 'Kênh video',
  'image_channel_kicker': 'Kênh ảnh',
  'text_channel_kicker': 'Kênh văn bản',
  'audio_channel_kicker': 'Kênh âm thanh',
  ...
  'project_settings_kicker': 'Bàn dự án',
  ...
  'visual_style_kicker': 'Phong cách hình ảnh',
  'engine_routing_kicker': 'Định tuyến công cụ',
  ...
  'edit_provider_kicker': 'Chỉnh sửa nhà cung cấp',
  'new_provider_kicker': 'Nhà cung cấp mới',
  'connection_info_kicker': 'Thông tin kết nối',
  'cp_name_label': 'Tên',
  ...
  'tool_name_reset_episode_plan': 'Xóa kế hoạch tập',
  'tool_name_patch_reference_video_unit_prompt': 'Ghi prompt video tham chiếu',
  ...
  'skill_name_premium_video_prompt': 'Gợi ý video cao cấp',
  'skill_name_rewrite_script': 'Điều chỉnh kịch bản',
  'skill_name_script_to_shots': 'Tách cảnh kịch bản',
  'skill_name_short_drama_storyboard': 'Phân cảnh kịch ngắn',
  ...
  'script_policy_label': 'Chính sách kịch bản',
  'script_policy_preserve': 'Dùng nguyên bản',
  'script_policy_preserve_desc': 'AI chỉ tách, trích xuất tài sản và tạo prompt — không sửa văn bản',
  'script_policy_suggest': 'Đề xuất chỉnh sửa',
  ...
  'flow_readonly_hint': 'Chỉ đọc · Nhấn nút để xem chi tiết',
  'flow_status_idle': 'Chưa bắt đầu',
  'flow_status_active': 'Đang tiến hành',
  'flow_status_done': 'Hoàn thành',
  'flow_status_warn': 'Cần kiểm tra',
  'flow_status_blocked': 'Bị chặn',
  'flow_detail_counts': 'Số lượng',
  'flow_detail_items': 'Mục kiểm tra',
  'flow_count_total': 'Tổng',
  'flow_count_scripted': 'Đã tạo',
  'flow_count_missing': 'Thiếu',
  'flow_count_shots': 'Cảnh',
  'flow_count_units': 'Đơn vị',
  'flow_count_characters': 'Nhân vật',
  'flow_count_scenes': 'Bối cảnh',
  'flow_count_props': 'Đạo cụ',
  'flow_count_products': 'Sản phẩm',
  'flow_source_note': 'Kịch bản gốc được bảo vệ. Quy hoạch, JSON script, prompt là tác phẩm phái sinh.',
  'flow_preflight_placeholder': 'Mở trang episode để xem chi tiết kiểm tra.',
  'flow_video_gen_note': 'Tạo video tốn kém. Xem lại prompt trước, sau đó kích hoạt thủ công trên trang episode.',
  'flow_go_to': 'Đi tới',
