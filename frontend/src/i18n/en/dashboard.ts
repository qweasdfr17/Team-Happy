...
export default {
  ...
  'ad_short_video': 'Short / Manga Clip',
  'content_mode_ad_desc': 'Short mode — describe your creative intent with a Brief, and AI generates shots with Chinese video prompts based on your character/scene/prop reference images. Review and revise the prompts, then manually decide when to generate video. Best for manga clips, creative shorts, and product ads (products are optional).',
  ...
  'system_config_kicker': 'Control Booth',
  ...
  'key_issued_kicker': 'Key Issued',
  'new_token_kicker': 'New Token',
  ...
  'model_routing_kicker': 'Default Routing',
  'video_channel_kicker': 'Video Channel',
  'image_channel_kicker': 'Image Channel',
  'text_channel_kicker': 'Text Channel',
  'audio_channel_kicker': 'Audio Channel',
  ...
  'ad_short_video_mode': 'Short / Manga Clip Mode',
  ...
  'project_settings_kicker': 'Project Booth',
  ...
  'visual_style_kicker': 'Visual Style',
  'engine_routing_kicker': 'Engine Routing',
  ...
  'edit_provider_kicker': 'Edit Provider',
  'new_provider_kicker': 'New Provider',
  'connection_info_kicker': 'Connection',
  'cp_name_label': 'Name',
  ...
  'tool_name_reset_episode_plan': 'Reset episode plan',
  'tool_name_patch_reference_video_unit_prompt': 'Write reference video prompt',
  ...
  'tool_name_create_character_variant': 'Create character variant',
  'tool_name_update_character_variant': 'Update character variant',
  'tool_name_list_character_variants': 'List character variants',
  ...
  'ad_init_title': 'Prepare Creative Materials',
  'ad_init_subtitle': 'Write your creative brief, optionally upload product photos and info, to start generating shot prompt drafts',
  ...
  'ad_init_brief_placeholder': 'Describe the short video you want: theme, tone, mood, narrative pace… (add selling points and CTA for product ads)',
  ...
  // ---- Short / Manga Clip · reference-to-video derived grouping ----
  ...
  'flow_readonly_hint': 'Read-only · Click node for details',
  'flow_status_idle': 'Idle',
  'flow_status_active': 'Active',
  'flow_status_done': 'Done',
  'flow_status_warn': 'Check',
  'flow_status_blocked': 'Blocked',
  'flow_detail_counts': 'Counts',
  'flow_detail_items': 'Items',
  'flow_count_total': 'Total',
  'flow_count_scripted': 'Scripted',
  'flow_count_missing': 'Missing',
  'flow_count_shots': 'Shots',
  'flow_count_units': 'Units',
  'flow_count_characters': 'Characters',
  'flow_count_scenes': 'Scenes',
  'flow_count_props': 'Props',
  'flow_count_products': 'Products',
  'flow_source_note': 'Original script is protected by default. Planning, JSON scripts, and prompts are derivative works.',
  'flow_preflight_placeholder': 'Open the episode page to view preflight details.',
  'flow_video_gen_note': 'Video generation is costly. Review prompts first, then trigger manually on the episode page.',
  'flow_go_to': 'Go',
